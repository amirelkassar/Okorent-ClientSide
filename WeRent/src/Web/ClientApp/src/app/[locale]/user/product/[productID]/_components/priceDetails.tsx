...
function PriceDetails() {
  return (
    <div className=" border rounded-lg bg-white/50 pt-4 pb-2  border-green/30">
      <div className="px-5">
        <h3 className="text-base font-Bold text-grayMedium mb-4">
          ₣ 25.00 / <span className=" font-Regular text-grayMedium">day</span>{" "}
        </h3>
        ...
        <ul className="flex flex-col gap-2 w-full">
          <li className="flex items-center justify-between gap-3 flex-wrap">
            <h5 className="text-[14px] text-grayMedium font-Regular">$20.00 x 9 Days</h5>
            <p className="text-[14px] text-grayMedium font-Regular">$180.00</p>
          </li>
          <li className="flex items-center justify-between gap-3 flex-wrap">
            <h5 className="text-[14px] text-grayMedium font-Regular">Service fee</h5>
