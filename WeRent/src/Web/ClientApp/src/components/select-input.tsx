...
const SelectInput: React.FC<SelectInputProps> = ({
  ...
  return (
    <Select
      ...
      classNames={{
        input: `text-black rounded-xl min-h-[54px] h-[54px] h-full text-grayMedium border border-green/30 focus:border-green active:border-green placeholder:text-grayMedium placeholder:opacity-100 ${inputClassName}`,
        wrapper: "h-auto",
