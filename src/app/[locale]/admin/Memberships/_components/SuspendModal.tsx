...
import DateSuspendModal from "./DateSuspendModal";
...
function SuspendModal({ opened, close, id }: any) {
  console.log(id);
  const [valueSuspend, setValueSuspend] = useState("");

  return (
    <>
      <ModalComp opened={opened} close={close} title={"Suspend Plan"}>
        <div className="lg:w-[580px] w-full">
          ...
          {valueSuspend === "specific" && <DateSuspendModal />}
