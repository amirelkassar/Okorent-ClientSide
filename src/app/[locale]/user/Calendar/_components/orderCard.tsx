...
function OrderCard({ resource }: any) {
  ...
  return (
    <div className="flex min-h-[80px] flex-col lgl:flex-row lgl:items-center lgl:justify-between gap-1 lgl:gap-3 px-1 flex-wrap lgl:px-5  py-3">
      <div className="flex items-center gap-3">
        <div className=" size-[50px] min-w-[50px] hidden lgl:flex items-center justify-center bg-grayBack rounded-full p-[6px]">
          <Image
            alt="order"
            src={resource._resource.extendedProps.img}
        ...
        <div className="max-w-full">
          <h3 className="text-xs lgl:text-base font-SemiBold text-wrap truncate max-w-full ">
