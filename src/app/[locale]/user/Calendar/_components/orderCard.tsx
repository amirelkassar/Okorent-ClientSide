    ...
    <div className="flex min-h-[70px] flex-col lgl:flex-row lgl:items-center lgl:justify-between gap-1 lgl:gap-3 px-1 flex-wrap lgl:px-5  py-3">
      <div className="flex items-center gap-3 flex-1 max-w-full">
        ...
        <div className="max-w-full w-full">
          <h3 className="text-xs lgl:text-base font-SemiBold  truncate max-w-full mdl:max-w-[calc(100%-100px)] w-full ">
            {resource._resource.extendedProps.productName}
          </h3>
          <p className="text-[10px] lgl:text-sm font-Regular text-grayMedium truncate max-w-full mdl:max-w-[calc(100%-100px)] w-full">
