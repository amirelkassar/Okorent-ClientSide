    ...
    <div className="flex  justify-between flex-wrap xl:flex-nowrap gap-5 bg-white/50 rounded-3xl border-green/70 border shadow-md py-6 md:py-10 px-3 md:px-8   order-3 lg:order-2 ">
      <div className="flex-1">
        <div className="flex items-center justify-between mb-6 md:mb-10">
          <h3 className="text-lg md:text-2xl font-Regular ">Billing Info & payment</h3>
        ...
        <div className="flex gap-6 flex-col md:flex-row mdl:gap-10 justify-between">
          <div>
            ...
            <ul className="flex flex-col gap-1">
              <li className="text-grayMedium font-Regular text-base ">Mark James</li>
              <li className="text-grayMedium font-Regular text-base ">mark@gmail.com</li>
              <li className="text-grayMedium font-Regular text-base ">Essen, Egypt</li>
              <li className="text-grayMedium font-Regular text-base ">P.O Box 2300</li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex gap-4 lgl:gap-9">
              ...
              <button onClick={open2} className="text-blue font-Regular text-base">
                Change{' '}
              </button>
            </div>
          </div>
