...
function CardStatistical({
  ...
  return (
    <div className="pt-[14px] flex-1 lg:pt-7 mb-2 px-4 lg:px-9 pb-3 lg:pb-6  min-w-[190px] lg:min-w-[300px] w-full max-w-full  bg-white lg:pe-10  rounded-[24px] border border-green flex items-center justify-between gap-5 shadow-md">
      <div>
